...
export class StaticResolver {
  ...
  @Query(() => PetsResponse, {
      name: "gamePets",
      description:
      "Return a full list of supported pet species, including their base stats and income properties.",
  })
  ...
  @Query(() => StoreItemsResponse, {
      name: "gameStoreItems",
      description:
      "Return all store items available for purchase, including cost, rarity, and category metadata.",
  })
