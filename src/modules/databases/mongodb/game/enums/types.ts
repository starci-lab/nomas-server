...
registerEnumType(GraphQLTypeStoreItemType, {
    ...
    valuesMap: {
        ...
        [StoreItemType.Furniture]: { description: "Furniture items are decorative or utility items placed in the player’s home or room." },
        [StoreItemType.Background]: { description: "Background items are visual backgrounds for the player’s environment or habitat." },
